...
const teamMembers = [
  {
    ...
    credentials: "B.Tech (Electronics) | MBB Master Black Belt | Lean Six Sigma | PMP | ITIL",
    description: "Formerly with TCS and Renoir Consulting, Varun brings rich consulting experience across Southeast Asia, the Middle East, and India, specializing in operations, supply chain, HR, sales, ERP, and sustainable tech across diverse industries.",
  ...
  },
  {
    ...
    description: "Expert in large-scale operations management with extensive experience in healthcare administration and strategic leadership. Proven ability to drive organizational growth through process optimization and decision-making.",
